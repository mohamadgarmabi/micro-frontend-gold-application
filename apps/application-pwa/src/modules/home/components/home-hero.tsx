  ...
  return (
    <Card className="space-y-4 p-5">
      <div className="flex justify-between items-start gap-3">
        <div>
          <p className="text-muted text-xs uppercase tracking-widest">{quote.eyebrow}</p>
          <h2 className="mt-1 font-semibold text-foreground text-base">{quote.pairLabel}</h2>
        </div>
